      ...
      <div className="flex justify-between mt-2">
        ...
        <div className="grid grid-cols-3 mt-2">
          <div className="flex justify-center items-center">
            <img src="/icon/health.svg" style={imgstyle} alt="" />
            <div className="text-white ml-2">
              <p className="text-sm-md">16</p>
            </div>
          </div>
          <div className="flex justify-center items-center">
            <img src="/icon/generation.svg" style={imgstyle} alt="" />
            <div className="text-white ml-2">
              <p className="text-sm-md">18</p>
            </div>
          </div>
          <div className="flex justify-center items-center">
            <img src="/icon/attack.svg" style={imgstyle} alt="" />
            <div className="text-white ml-2">
              <p className="text-sm-md">16</p>
            </div>
          </div>
          <div className="flex justify-center items-center">
            <img src="/icon/defend.svg" style={imgstyle} alt=""/>
            <div className="text-white ml-2">
              <p className="text-sm-md">19</p>
            </div>
          </div>
          <div className="flex justify-center items-center">
            <img src="/icon/speed.svg" style={imgstyle} alt=""/>
            <div className="text-white ml-2">
              <p className="text-sm-md">17</p>
            </div>
          </div>
          <div className="flex justify-center items-center">
            <img src="/icon/morale.svg" style={imgstyle} alt=""/>
            <div className="text-white ml-2">
              <p className="text-sm-md">19</p>
            </div>
          </div>
